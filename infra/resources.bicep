...
output OPENAI_GPT_MODEL string = openAI.outputs.gptModelName
output OPENAI_EMBEDDING_MODEL string = openAI.outputs.embeddingModelName
output KEYVAULT_OPENAI_ENDPOINT string = secrets.outputs.endpointSecretName
output KEYVAULT_OPENAI_API_KEY string = secrets.outputs.apiKeySecretName
